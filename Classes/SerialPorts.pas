{------------------------------------------------------------------------------
  ...
  Unit      : SerialPorts (SerialPorts.pas)
  Description
    Manages serial port configuration and communication, including reader and
    writer threads with notification callbacks for received data.
